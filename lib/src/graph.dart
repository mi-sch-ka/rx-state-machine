...
class Graph<STATE, EVENT, SIDE_EFFECT> {
  Graph(this.initialState, this.finishStates, this.stateDefinitions,
      this.onTransitionListeners);
...
class GraphBuilder<STATE, EVENT, SIDE_EFFECT> {
  ...
  late final Map<Type, _State<STATE, EVENT, SIDE_EFFECT>> _stateDefinitions =
      _graph?.stateDefinitions ?? {};
  late List<TransitionListener<STATE, EVENT, SIDE_EFFECT>>
      _onTransitionListeners = _graph?.onTransitionListeners ?? [];
  ...
  Graph<STATE, EVENT, SIDE_EFFECT> build() => Graph(
      _initialState!, _finishStates, _stateDefinitions, _onTransitionListeners);
}
